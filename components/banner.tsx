  ...
  return (
    <div className="grid grid-cols-12 gap-4 items-center h-5/6 mb-10">
        <div className="col-span-12 md:col-span-6 xl:col-span-7 py-20">
            ...
            <p className="text-lg mt-6 text-slate-700">I am a software developer who focuses on writing clean, elegant and efficient codes and responsive designs. I&apos;m also experience in taking fullstack applications from scratch to production.</p>
