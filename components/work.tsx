...
const Work = () => {
  return (
    <div className='flex justify-center flex-col py-10'>
        ...
        <div className='grid grid-cols-12 gap-12 content-evenly px-10'>
            <div className='col-span-6 p-5 bg-slate-50 gap-6 flex justify-start items-center cursor-pointer hover:bg-gradient-to-r from-yellow-100 via-pink-100 to-slate-50 transition-colors'>
                <div>
                    <Image
                        src="/frontend.png"
                        alt="Frontend"
